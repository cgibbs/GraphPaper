...
in the area inside the three points. Both of these are a 
tiny bit buggy, and will occasionally draw a line as though 
you re-selected the last place you clicked. Also, the places 
you can click include not just the grey points, but the middle 
points between them. Try it out, you'll see what I mean. In 
Fill Mode, you just click an area between the grey points, and 
it fills it in. Easy peasy.