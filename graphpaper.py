...
def draw_overlay(screen,color,mode,selected,sel_tri1,sel_tri2):
    text18 = pygame.font.Font("freesansbold.ttf", 16)
...
def main():
    ...
    while running:
            ...
            draw_screen(screen)
            draw_overlay(screen,color,mode,selected,sel_tri1,sel_tri2)
            pygame.display.flip()
